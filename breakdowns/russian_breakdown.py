...
def breakdownWord(word, recursive=False):
    ...
    simple_convert = {
        ...
        'v': 'V',
        'x': 'HH',  # use 'Y' ?? 'K'??
        u'\N{LATIN SMALL LETTER S WITH CARON}': 'SH',  # �
        u'\N{LATIN SMALL LETTER Z WITH CARON}': 'ZH',  # �
        u'\N{LATIN CAPITAL LETTER S WITH CARON}': 'SH',  # �
        u'\N{LATIN CAPITAL LETTER Z WITH CARON}': 'ZH',  # �
        # Cyrillic
...
if __name__ == "__main__":
    testwords = "�gaux Vse ljudi ro�dajutsya svobodnymi i ravnymi v svoem dostoinstve i pravah Oni nadeleny razumom i sovest'ju i dol�ny postupat' v otno�enii drug druga v duhe bratstva".split()
